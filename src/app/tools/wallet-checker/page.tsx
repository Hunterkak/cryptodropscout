...
export default function WalletCheckerPage() {
  ...
  async function checkWallet() {
    ...
    try {
      ...
      const res =
        await fetch(
          `/api/wallet?address=${walletAddress}&network=all`
        );
    ...
    <main className="min-h-screen bg-[#f8f7f2] text-gray-900">
      ...
      <div className="text-center pt-10 pb-6">
        ...
        <p className="text-gray-500 text-sm">
          Wallet Portfolio + Airdrop History Tracker
        </p>
          ...
          <div className="flex gap-3">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 pr-10 text-black rounded-xl border border-gray-200 outline-none text-sm placeholder-gray-400 focus:border-green-400"
              />
            ...
            <div className="space-y-2">
              ...
              {!searched && (
                ...
                <div className="text-center py-16 text-gray-400">
                  ...
                  <p className="text-sm">
                    Enter a wallet address above to see real token holdings
                  </p>
                ...
                loading && (
                  ...
                  <div className="text-center py-16 text-gray-400">
                    ...
                    <p className="text-sm animate-pulse">
                      Fetching tokens across all chains...
                    </p>
              ...
              {searched &&
                ...
                tokens.map(
                  (
                    ...
                    <div
                      key={i}
                      className="bg-white rounded-2xl border border-gray-100 px-5 py-4 flex items-center justify-between"
                    >
